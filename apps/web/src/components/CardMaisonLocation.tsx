...
export default function CardMaisonLocation({
  ...
  const priceInEuros = maison.pricePerNight / 100;
  ...
  maxWidth: variant === 'compact' ? '20px' : '350px',
  width: '100%',
          ...
          {formattedAmenities.length > 0 && (
            <div style={amenitiesContainerStyles}>
              <div style={amenitiesGridStyles}>
                ...
                {maison.amenities.length > 4 && (
                  <span style={{
                    ...amenityTagStyles,
                    backgroundColor: '#dbeafe',
                    color: '#1d4ed8'
                  }}>
                    +{maison.amenities.length - 4} autres
                  </span>
                )}
              </div>
            </div>
